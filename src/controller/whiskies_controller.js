...
exports.getData = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        if (err) {
            ...
            response.status(200).json(JSON.parse(data).whiskies)
        }
    }
    );
};
...
exports.getDataById = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            const dataById = manipData.whiskies.find(
...
exports.getDataByName = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            const dataByName = manipData.whiskies.find(
...
exports.post = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            //on ajoute la donnée
            existingData.whiskies.push(request.body)
...
exports.modif =  (request, response) => {
  ...
  //Sinon
            ...
            const data_id = existing_data.whiskies.find(
                (obj) => obj.id === parseInt(request.params.id)
            );
...
exports.deleteDataById = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json" , (err, data) => {
        ...
        if (err) {
          ...
          const dataById = existingData.whiskies.find(
            (obj) => obj.id === parseInt(request.params.id)
          );
          ...
          if (!dataById) {
            ...
            existingData.whiskies = existingData.whiskies.filter(
                (obj) => obj.id != parseInt(request.params.id));
            fs.writeFile("./src/model/bar.json", JSON.stringify(existingData), (writeErr) => {
