...
exports.getData = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        if (err) {
            ...
            response.status(200).json(JSON.parse(data).cocktails)
        }
    }
    );
};
...
exports.getDataById = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            const dataById = manipData.cocktails.find(
...
exports.getDataByName = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            const dataByName = manipData.cocktails.find(
...
exports.post = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            //on ajoute la donnée
            existingData.cocktails.push(request.body)
...
exports.modif =  (request, response) => {
  ...
  //Sinon
            ...
            const data_id = existing_data.cocktails.find(
                (obj) => obj.id === parseInt(request.params.id)
            );
...
exports.deleteDataById = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json" , (err, data) => {
        ...
        if (err) {
          ...
          const dataById = existingData.cocktails.find(
            (obj) => obj.id === parseInt(request.params.id)
          );
          ...
          if (!dataById) {
            ...
            existingData.cocktails = existingData.cocktails.filter(
                (obj) => obj.id != parseInt(request.params.id));
            fs.writeFile("./src/model/bar.json", JSON.stringify(existingData), (writeErr) => {
