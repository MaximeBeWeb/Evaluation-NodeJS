...
exports.getData = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        if (err) {
            ...
            response.status(200).json(JSON.parse(data).bieres)
        }
    }
    );
};
...
exports.getDataById = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            const dataById = manipData.bieres.find(
...
exports.getDataByName = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            const dataByName = manipData.bieres.find(
...
exports.post = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json", (err, data) => {
        ...
        if (err) {
            ...
            //on ajoute la donnée
            existingData.bieres.push(request.body)
...
exports.modif =  (request, response) => {
  ...
  //Sinon
            ...
            const data_id = existing_data.bieres.find(
                (obj) => obj.id === parseInt(request.params.id)
            );
...
exports.deleteDataById = (request, response) => {
    ...
    fs.readFile("./src/model/bar.json" , (err, data) => {
        ...
        if (err) {
          ...
          const dataById = existingData.bieres.find(
            (obj) => obj.id === parseInt(request.params.id)
          );
          ...
          if (!dataById) {
            ...
            existingData.bieres = existingData.bieres.filter(
                (obj) => obj.id != parseInt(request.params.id));
            fs.writeFile("./src/model/bar.json", JSON.stringify(existingData), (writeErr) => {
